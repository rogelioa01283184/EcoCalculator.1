...
Design Choices
-The program is structured using functions to separate responsibilities (one for input handling, calculations, data storage, and GUI interaction), making it clean and efficient.
